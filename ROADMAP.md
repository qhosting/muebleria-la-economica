...
VertexERP Muebles es un sistema integral de gestión de cobranza y administración de clientes diseñado específicamente para mueblerías que operan con créditos y cobranza en campo. El sistema funciona como una PWA (Progressive Web App) optimizada para dispositivos móviles y uso offline.
...
- **Impresión Bluetooth:** Soporte nativo para impresoras térmicas portátiles.
